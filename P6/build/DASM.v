...
module DASM (
    ...
    wire [7*8-1:0] simm_dec_signed = {sp, imm[15] ? "-" : " ", get_hex(imm32_signed / 10000 % 10), get_hex(imm32_signed / 1000 % 10), get_hex(imm32_signed / 100 % 10), get_hex(imm32_signed / 10 % 10), get_hex(imm32_signed % 10)};
    ...
    wire [26*8-1:0] _rs_rt_imm = {
        srs, srt, imm_as_dec ? simm_dec_signed : simm, "[", get_hex(branch_npc[31:28]), get_hex(branch_npc[27:24]), get_hex(branch_npc[23:20]), get_hex(branch_npc[19:16]), get_hex(branch_npc[15:12]), get_hex(branch_npc[11:8]), get_hex(branch_npc[7:4]), get_hex(branch_npc[3:0]), "]"
    };
    wire [22*8-1:0] _rs_imm = {
        srs, imm_as_dec ? simm_dec_signed : simm, "[", get_hex(branch_npc[31:28]), get_hex(branch_npc[27:24]), get_hex(branch_npc[23:20]), get_hex(branch_npc[19:16]), get_hex(branch_npc[15:12]), get_hex(branch_npc[11:8]), get_hex(branch_npc[7:4]), get_hex(branch_npc[3:0]), "]"
    };  // branch
    wire [10*8-1:0] _rt_imm = {srt, imm_as_dec ? simm_dec : simm};
    wire [8*8-1:0] _rs_rt = {srs, srt};
    wire [9*8-1:0] _target = {" 0", get_hex(target[25:22]), get_hex(target[21:18]), get_hex(target[17:14]), get_hex(target[13:10]), get_hex(target[9:6]), get_hex(target[5:2]), get_hex({target[1:0], 2'b0})};
